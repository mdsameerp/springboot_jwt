package com.ipigeon.app.Security;
...
import com.ipigeon.app.filters.JwtRequestFilter;
...
//	private BCryptPasswordEncoder bCryptPasswordEncoder;
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable()
				...
				.antMatchers("/traveler_registration").permitAll()
				.antMatchers("/sender_registration").permitAll()
