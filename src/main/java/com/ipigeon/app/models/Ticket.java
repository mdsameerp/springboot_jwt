...
public class Ticket {
	...
	boolean verified;	//set by admin once ticket is checked online with issuer.
	...
	public void setTraveller(Traveler traveler) {
	...
	public Ticket(long id, Traveler traveler, @NotEmpty(message = "*Please provide source city") String source_city,
	...
	public Ticket(Traveler traveler, @NotEmpty(message = "*Please provide source city") String source_city,
			@NotEmpty(message = "*Please provide source state") String source_state,
			@NotEmpty(message = "*Please provide destination city") String destination_city,
			@NotEmpty(message = "*Please provide destination state") String destination_state,
			@NotNull(message = "*Please provide departure date") LocalDateTime departure_date,
	...
	public String toString() {
		return "Ticket [id=" + id + ", datetime=" + datetime + ", traveler=" + traveler + ", source_city="
